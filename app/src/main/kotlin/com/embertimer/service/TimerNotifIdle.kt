...
object TimerNotifIdle {
    ...
    internal fun ackPendingIntent(context: Context): PendingIntent = PendingIntent.getService(
        context,
        ACK_REQ,
        android.content.Intent(context, com.embertimer.service.TimerService::class.java)
            .setAction(com.embertimer.service.ACTION_ACK),
        PendingIntent.FLAG_UPDATE_CURRENT or PendingIntent.FLAG_IMMUTABLE,
    )
    ...
    internal fun startPendingIntent(context: Context, profile: com.embertimer.data.db.ProfileEntity): PendingIntent = PendingIntent.getService(
