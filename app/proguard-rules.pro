...
-keep class com.embertimer.data.AutoBackupWorker { *; }
-keepnames class * extends androidx.work.ListenableWorker
-keep class * extends androidx.work.WorkerParameters { *; }

# --- 应用入口 / 组件(manifest 声明,R8 一般会自动保留,显式声明更稳) ---
-keep class com.embertimer.EmberApp { *; }
-keep class com.embertimer.MainActivity { *; }
-keep class com.embertimer.service.** { *; }
...
-keep class com.embertimer.data.db.** { *; }
